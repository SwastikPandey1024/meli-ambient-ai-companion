#!/usr/bin/env python3
"""
generate_clean_standalone_specials.py — Master Generator for Clean Standalone Special States

Generates 4 complete, unified, standalone character performance illustrations:
1. PROXIMITY   — Quiet awareness (observant side-gaze, relaxed stance, soft rose heart, zero sparkles)
2. HOVER       — Active engagement (playful tilt, drawstring hold, wide direct sparkle eyes, open smile, emerald glow, 2 sparkles)
3. CLICK_PET   — Tactile reaction (compact bashful posture, hands near cheeks, bashful blush squint > <, wavy smile, 3 floating hearts)
4. CELEBRATION — Milestone victory (triumphant raised fist pump, open toothy victory smile, emerald burst, confetti sparkles)

Contract:
- 512x512 RGBA PNG
- Transparent background (corners alpha=0)
- Grounding baseline at Y=493-495
- Single standalone PNG per state (ZERO runtime compositing, ZERO face patches)
- Preserves exact canonical Meli identity and style
"""
...
# ==============================================================================
# 1. PROXIMITY — "Meli notices you nearby" (Low Energy)
# ==============================================================================
def render_proximity():
    ...
    # Clean almond eyes looking upper-left
    ...
    # Irises shifted upper-left (tracking cursor)
    ...
    # NO sparkles for Proximity
    return canvas

# ==============================================================================
# 2. HOVER — "Meli knows you are directly interacting with her" (Medium Energy)
# ==============================================================================
def render_hover():
    base = Image.open("assets/meli/character/states/meli_idle.png").convert("RGBA")
    w, h = 512, 512
...
# ==============================================================================
# 3. CLICK_PET — "Meli physically reacts to being touched/petted" (Med-High Energy)
# ==============================================================================
def render_click_pet():
    ...
    # Bashful squeezed smiling blush eyes (> <)
...
# ==============================================================================
# 4. CELEBRATION — "Meli celebrates an accomplishment" (Very High Energy)
# ==============================================================================
def render_celebration():
    ...
    # Brilliant Emerald Signal Heart Triumph Burst
    hx, hy = 259, 183
    ...
    # Celebratory Sparkles & Confetti Stars
    s1 = create_sparkle_diamond(size=18, color=(255, 215, 0, 250))
    canvas.paste(s1, (356, 46), s1)
    s2 = create_sparkle_diamond(size=14, color=(0, 230, 118, 240))
    canvas.paste(s2, (158, 140), s2)
    s3 = create_sparkle_diamond(size=12, color=(255, 105, 180, 240))
    canvas.paste(s3, (348, 198), s3)
    s4 = create_sparkle_diamond(size=10, color=(255, 255, 255, 255))
    canvas.paste(s4, (198, 70), s4)

    return canvas

def main():
    print("=== STANDALONE SPECIAL PERFORMANCE ASSET GENERATION ===")
    ...
    print("[SUCCESS] All 4 special performance assets generated and saved.")
