#!/usr/bin/env python3
"""
build_standalone_special_masters.py — Authoritative Generator for All 4 Special Performance States

Generates 4 genuinely distinct, standalone full-body character performances:
1. PROXIMITY   — Quiet awareness (attentive side-gaze, relaxed stance, soft rose heart, NO sparkles)
2. HOVER       — Active engagement (playful tilt, drawstring hold, wide direct sparkling eyes, open smile, emerald glow, 2 sparkles)
3. CLICK_PET   — Tactile reaction (compact bashful posture, hands near cheeks, squeezed blush eyes > <, wavy mouth, 3 heart particles)
...
- Grounding baseline at Y=495 (in [485, 505])
- Single standalone PNG per state (ZERO runtime compositing)
- Preserves exact canonical Meli identity
"""
...
def render_proximity():
    ...
    # Attentive almond eyes looking upper-left
